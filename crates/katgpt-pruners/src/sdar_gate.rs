...
///
/// ```
/// use katgpt_pruners::sdar_gate::{sdar_gate, SDAR_BETA};
///
...
///
/// ```
/// use katgpt_pruners::sdar_gate::{sdar_modulate, SDAR_BETA};
///
...
///
/// ```
/// use katgpt_pruners::sdar_gate::{sdar_benefit_gate, SDAR_BETA};
///
