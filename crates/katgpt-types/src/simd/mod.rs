...
pub use research::{coincidence_score, entropy_f32, simd_dist_sq, simd_fused_scale_acc, simd_fused_sub_acc, simd_l_inf_distance_f32, simd_gram_f32, simd_sum_abs_f32, simd_sum_sq, simd_sum_sq_quartic};
