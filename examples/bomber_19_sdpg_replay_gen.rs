...
fn main() {
    ...
    let (gate_a_wins, gate_a_total, gate_a_dur) = run_matchup(&mut gate_a_players, &goat_config);
    print_stats(
        &gate_a_names,
        &gate_a_emojis,
        &gate_a_wins,
    ...
    let (gate_b_wins, gate_b_total, gate_b_dur) = run_matchup(&mut gate_b_players, &goat_config);
    print_stats(
        &gate_b_names,
        &gate_b_emojis,
        &gate_b_wins,
