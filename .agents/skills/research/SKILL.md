...
**Commercial strategy / moat map (single entrypoint — read once per verdict run, not inline):**
- `katgpt-rs/.research/003_Commercial_Open_Source_Strategy_Verdict.md` — public routing-rules subset (5-repo roles, What/How rule, Super-GOAT routing).
- `riir-ai/.research/003_Commercial_Open_Source_Strategy_Verdict.md` — full internal strategy doc (moat analysis, "why hard to replicate", cognitive/reasoning moat, tier model detail). Too commercially sensitive for the public MIT repo.
- `riir-ai/.docs/README.md` (+ `pillars/README.md`, `supergoat_candidates/README.md`) — the live moat map by capability. Read these for any Super-GOAT novelty gate or "does this become a pillar?" question.
