...
- [ ] **Task 2: Implement `TurboQuantCodebook` (Lloyd-Max scalar quantizer)**
- [ ] **Task 3: Implement `RandomRotation` (QR-based orthogonal matrix)**
- [ ] **Task 4: Implement `TurboQuantKVCache` struct**
