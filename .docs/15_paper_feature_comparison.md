...
| 62 SHINE | Context→LoRA hypernetwork, alternating 2D attention | `shine_hypernet` / `shine_routing` features (riir-ai runtime; training deferred → `riir-train/.plans/302_shine_context_to_lora_hypernetwork_DEFERRED.md`) |
